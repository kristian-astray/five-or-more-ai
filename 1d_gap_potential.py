# Heuristic: Line Potential + Gap Potential + Cleared Bonus
# Gap potential extends line potential by rewarding almost-complete 5-cell windows with gaps.
    ...
    for sr, sc in occupied:
        for dr, dc in empty:
            if check_move(current_node, (sr, sc), (dr, dc)):
                ...
                heuristic_score = line_potential + 0.1 * gap_potential + cleared_bonus                           
