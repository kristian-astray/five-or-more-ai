# Heuristic: Path Mobility
# Adjacency Path Based Mobibility based on BFS: Useful mobility count where useful is defined by a move that allows for adjacent color tiles
    ...
    for sr, sc in occupied:
        for dr, dc in empty:
            if check_move(current_node, (sr, sc), (dr, dc)):
                ...
                heuristic_score = 1.0 * line_potential + 0.1 * gap_potential + 0.01 * path_mobility + cleared_bonus  
                1.0, 0.1, 0.005
